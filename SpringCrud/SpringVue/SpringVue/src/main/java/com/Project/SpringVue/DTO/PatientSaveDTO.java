...
public class PatientSaveDTO {
	...
	public PatientSaveDTO(String patientname, String patientaddress, int phone, Doctor doctor, List<Appointment> appointments, List<Examination> examinations) {
	...
	public String toString() {
		return "PatientSaveDTO [patientname=" + patientname + ", patientaddress="
